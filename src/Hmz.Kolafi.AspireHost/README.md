...
1. Set `Hmz.Kolafi.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../Hmz.Kolafi.Infrastructure/Hmz.Kolafi.Infrastructure.csproj -s Hmz.Kolafi.Web.csproj -o Data/Migrations
```

To update the database:
```bash
dotnet ef database update -c AppDbContext -p ../Hmz.Kolafi.Infrastructure/Hmz.Kolafi.Infrastructure.csproj -s Hmz.Kolafi.Web.csproj
```
